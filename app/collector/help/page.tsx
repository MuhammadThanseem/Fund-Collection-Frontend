...
import {
  ...
  FiPhone, FiMail, FiExternalLink, FiUsers, FiDollarSign, FiShield, FiHome,
} from "react-icons/fi";
...
const FAQS: FAQ[] = [
  {
    q: "How do I add a new household (customer)?",
    a: "Go to the Customers page and click 'Add Household'. Fill in the household name, phone number, box number, and address. The household will be added to your list immediately and you can start collecting from them.",
  },
  {
    q: "How do I record a collection entry?",
    a: "Go to the Collections page, select the customer, enter the amount collected, choose the payment method, and tap 'Save Collection'. The entry will be saved and reflected in your daily progress on the dashboard.",
  },
  {
    q: "What does the customer status mean?",
    a: "'Collected' means you have recorded a collection for this customer in the current month. 'Pending' means no collection recorded yet this month. 'Overdue' means the customer has been in the system for over 30 days with no collection recorded.",
  },
  {
    q: "Can I collect from the same household twice in a month?",
    a: "Yes. You can record multiple collection entries for the same customer in the same month. Each entry is saved separately with a date and amount.",
  },
  {
    q: "How do I change my password?",
    a: "Go to Settings, click the Security tab, enter your current password, then enter and confirm your new password, and click Save Changes.",
  },
  {
    q: "What if the box number I want to assign is already taken?",
    a: "Box numbers must be unique across the system. If the number is taken, you will see an error when saving. Use a different box number or contact your admin to resolve the conflict.",
  },
  {
    q: "How is my daily progress calculated?",
    a: "The daily progress bar on your dashboard counts the number of collection entries you have recorded today against your daily target of 20. Each saved entry — regardless of amount — counts as one.",
  },
  {
    q: "Who do I contact if I face an issue?",
    a: "Reach out to your branch admin or contact our support team via the details in the 'Still need help?' section below. Support is available Sunday–Thursday, 9am–5pm.",
  },
];

const QUICK_LINKS = [
  { label: "My Dashboard",  icon: FiHome,       href: "/collector" },
  { label: "Customers",     icon: FiUsers,      href: "/collector/customers" },
  { label: "Collections",   icon: FiDollarSign, href: "/collector/collections" },
  { label: "Settings",      icon: FiShield,     href: "/collector/settings" },
];
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="text-center py-6">
        ...
        <p className="text-slate-500 text-sm mt-2 max-w-md mx-auto">
          Find answers to common questions about collecting and managing households.
        </p>
